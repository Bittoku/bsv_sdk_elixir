defmodule BSV.Transaction.P2PKH do
  @moduledoc "P2PKH signing template."
  ...
  @doc "Create a P2PKH locking script from an address string."
  @spec lock(String.t()) :: {:ok, Script.t()} | {:error, term()}
  def lock(address_string) do
    Address.to_script(address_string)
  end

  @doc "Create an unlocker struct."
